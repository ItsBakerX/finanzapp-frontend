...
const BuchungWiederkehrend: React.FC<BuchungProps> = ({
    buchung, kategorien, pockets, onDelete, openDropdownId, setOpenDropdownId }) => {
    ...
    const intervall = intervalle[buchung.intervall!] || buchung.intervall;

    return (
        <div className="buchungCard">
            <div className="buchungCardPC">
                <img src={reload_wiederkehrend} alt="Grocery Icon" className='buchungCardIcon' />
                <div>
...
export default BuchungWiederkehrend;