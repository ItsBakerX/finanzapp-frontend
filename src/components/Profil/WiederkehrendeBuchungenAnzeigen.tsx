...
import { getAllebuchungenWiederkehrend, getAlleKategorien, getAllePockets } from '../../backend/api';
...
function WiederkehrendeBuchungenAnzeigen() {
    ...
    return (
        <div className="wiederkehrende-buchungen">
...
export default WiederkehrendeBuchungenAnzeigen;